...
Defined in: [api/session/user-session.ts:14](https://github.com/davinidae/umazing-musumengine/blob/55af289200011bec94c06bda35867acecb08e9ac/src/api/session/user-session.ts#L14)
...
Defined in: [api/session/user-session.ts:47](https://github.com/davinidae/umazing-musumengine/blob/55af289200011bec94c06bda35867acecb08e9ac/src/api/session/user-session.ts#L47)
...
Defined in: [api/session/user-session.ts:31](https://github.com/davinidae/umazing-musumengine/blob/55af289200011bec94c06bda35867acecb08e9ac/src/api/session/user-session.ts#L31)
...
Defined in: [api/session/user-session.ts:56](https://github.com/davinidae/umazing-musumengine/blob/55af289200011bec94c06bda35867acecb08e9ac/src/api/session/user-session.ts#L56)
...
Defined in: [api/session/user-session.ts:39](https://github.com/davinidae/umazing-musumengine/blob/55af289200011bec94c06bda35867acecb08e9ac/src/api/session/user-session.ts#L39)
