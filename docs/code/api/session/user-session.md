...
Defined in:
[api/session/user-session.ts:14](https://github.com/davinidae/umazing-musumengine/blob/53589098f19178584a73b07fd43b6a78f63365fa/src/api/session/user-session.ts#L14)
...
Defined in:
[api/session/user-session.ts:47](https://github.com/davinidae/umazing-musumengine/blob/53589098f19178584a73b07fd43b6a78f63365fa/src/api/session/user-session.ts#L47)
...
Defined in:
[api/session/user-session.ts:31](https://github.com/davinidae/umazing-musumengine/blob/53589098f19178584a73b07fd43b6a78f63365fa/src/api/session/user-session.ts#L31)
...
Defined in:
[api/session/user-session.ts:56](https://github.com/davinidae/umazing-musumengine/blob/53589098f19178584a73b07fd43b6a78f63365fa/src/api/session/user-session.ts#L56)
...
Defined in:
[api/session/user-session.ts:39](https://github.com/davinidae/umazing-musumengine/blob/53589098f19178584a73b07fd43b6a78f63365fa/src/api/session/user-session.ts#L39)
