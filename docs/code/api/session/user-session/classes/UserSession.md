...
Defined in: [api/session/user-session.ts:13](https://github.com/davinidae/umazing-musumengine/blob/44f6e784adc57f5b49586071f4bdcb81060753f5/src/api/session/user-session.ts#L13)
...
Defined in: [api/session/user-session.ts:36](https://github.com/davinidae/umazing-musumengine/blob/44f6e784adc57f5b49586071f4bdcb81060753f5/src/api/session/user-session.ts#L36)
...
Defined in: [api/session/user-session.ts:44](https://github.com/davinidae/umazing-musumengine/blob/44f6e784adc57f5b49586071f4bdcb81060753f5/src/api/session/user-session.ts#L44)
...
Defined in: [api/session/user-session.ts:31](https://github.com/davinidae/umazing-musumengine/blob/44f6e784adc57f5b49586071f4bdcb81060753f5/src/api/session/user-session.ts#L31)
