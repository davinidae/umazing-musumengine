...
Defined in: [api/session/user-session.ts:13](https://github.com/davinidae/umazing-musumengine/blob/f0aa00e05dacca920f40c0772577d56aeee15536/src/api/session/user-session.ts#L13)
...
Defined in: [api/session/user-session.ts:36](https://github.com/davinidae/umazing-musumengine/blob/f0aa00e05dacca920f40c0772577d56aeee15536/src/api/session/user-session.ts#L36)
...
Defined in: [api/session/user-session.ts:44](https://github.com/davinidae/umazing-musumengine/blob/f0aa00e05dacca920f40c0772577d56aeee15536/src/api/session/user-session.ts#L44)
...
Defined in: [api/session/user-session.ts:31](https://github.com/davinidae/umazing-musumengine/blob/f0aa00e05dacca920f40c0772577d56aeee15536/src/api/session/user-session.ts#L31)
