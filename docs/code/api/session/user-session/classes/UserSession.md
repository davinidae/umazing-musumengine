...
Defined in: [api/session/user-session.ts:13](https://github.com/davinidae/umazing-musumengine/blob/6df8e3e1b8dfb16b24d04befbfa6d32c969e2756/src/api/session/user-session.ts#L13)
...
Defined in: [api/session/user-session.ts:36](https://github.com/davinidae/umazing-musumengine/blob/6df8e3e1b8dfb16b24d04befbfa6d32c969e2756/src/api/session/user-session.ts#L36)
...
Defined in: [api/session/user-session.ts:44](https://github.com/davinidae/umazing-musumengine/blob/6df8e3e1b8dfb16b24d04befbfa6d32c969e2756/src/api/session/user-session.ts#L44)
...
Defined in: [api/session/user-session.ts:31](https://github.com/davinidae/umazing-musumengine/blob/6df8e3e1b8dfb16b24d04befbfa6d32c969e2756/src/api/session/user-session.ts#L31)
