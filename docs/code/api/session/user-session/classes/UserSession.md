...
Defined in: [api/session/user-session.ts:12](https://github.com/davinidae/umazing-musumengine/blob/e31f12912bf088e7e67f5379b1fed36ba4f17894/src/api/session/user-session.ts#L12)
...
Defined in: [api/session/user-session.ts:51](https://github.com/davinidae/umazing-musumengine/blob/e31f12912bf088e7e67f5379b1fed36ba4f17894/src/api/session/user-session.ts#L51)
...
Defined in: [api/session/user-session.ts:30](https://github.com/davinidae/umazing-musumengine/blob/e31f12912bf088e7e67f5379b1fed36ba4f17894/src/api/session/user-session.ts#L30)

Access the pipeline context, if any.

#### Returns

[`PipelineContext`](../../../models/pipelines/interfaces/PipelineContext.md) \| `undefined`
...
Defined in: [api/session/user-session.ts:40](https://github.com/davinidae/umazing-musumengine/blob/e31f12912bf088e7e67f5379b1fed36ba4f17894/src/api/session/user-session.ts#L40)
...
Defined in: [api/session/user-session.ts:91](https://github.com/davinidae/umazing-musumengine/blob/e31f12912bf088e7e67f5379b1fed36ba4f17894/src/api/session/user-session.ts#L91)
...
Defined in: [api/session/user-session.ts:25](https://github.com/davinidae/umazing-musumengine/blob/e31f12912bf088e7e67f5379b1fed36ba4f17894/src/api/session/user-session.ts#L25)
...
Defined in: [api/session/user-session.ts:35](https://github.com/davinidae/umazing-musumengine/blob/e31f12912bf088e7e67f5379b1fed36ba4f17894/src/api/session/user-session.ts#L35)
